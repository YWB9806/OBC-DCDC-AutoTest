...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'V2_BSI_552','CPT_TEMPOREL_2',4553.5)
    STLA_CAN.DBC.SetSignal(1,'V2_BSI_552','CPT_TEMPOREL_1',6553.35)
    Sleep(2000)
    ...
    STLA_CAN.DBC.ExportWfmFile(['V2_BSI_552'],
                                ['CPT_TEMPOREL_2','CPT_TEMPOREL_1'],
                                ''
    )
    Sleep(2000)
