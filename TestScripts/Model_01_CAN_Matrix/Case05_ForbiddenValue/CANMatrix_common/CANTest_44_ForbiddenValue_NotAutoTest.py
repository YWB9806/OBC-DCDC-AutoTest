...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('MAX_ALLOW_CHRG_VOLTAGE', forbidden_values=[1000.1, 1319.1, 1638.1], normal_value=0, fault_code=138)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('MAX_ALLOW_CHRG_VOLTAGE'),'MAX_ALLOW_CHRG_VOLTAGE',1000,ConditionEnum.Morethan,0,0)
    StartTime1 = dArrTimeStamp1[0]
    Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',138,ConditionEnum.Equal,StartTime1,0)
    EndTime1 = dArrTimeStamp2[0]
    Test3, dArrTimeStamp3, dArrTimeStampList3 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('MAX_ALLOW_CHRG_VOLTAGE'),'MAX_ALLOW_CHRG_VOLTAGE',1300,ConditionEnum.Morethan,0,0)
    StartTime2 = dArrTimeStamp3[0]
    Test4, dArrTimeStamp4, dArrTimeStampList4 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',138,ConditionEnum.Equal,StartTime2,0)
    ...
    signal_list = ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE','DCDC_FAULT_STATE','OBC_FAULT_STATE',
                   ...
                   'ECU_ELEC_STATE_RCD','DCDC_STATE_BB','ACDC_CONVERSION_REQUEST','ACDC_CONVERSION_STATE','MAX_ALLOW_CHRG_VOLTAGE'
                   ]
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. /.\n"+
        f"3. Triggering a Level 3 failure, and reporting IFB_V_VerInfo6or13or20=138, and the replacemennt value is NA.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
