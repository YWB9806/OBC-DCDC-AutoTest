...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, Reserved_4 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_501','RESERVED_4', 0.0)
    TestResult = Reserved_4 == 0 
    print(f"RESERVED_4: {Reserved_4}, TestResult: {TestResult}")
