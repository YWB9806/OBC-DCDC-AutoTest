...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, DCDCHVOverCur = STLA_CAN.DBC.GetSignal(1,'DCDC_5A6','DCDC_HV_OVERCUR', 0.0)
    TestResult = DCDCHVOverCur == 0
    print(f"DCDC_HV_OVERCUR: {DCDCHVOverCur}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','DCDC_HV_OVERCUR'],
                                ''
    )
    Sleep(2000)
