...
if __name__ == '__main__':
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:SQU 1000,12.0,0,0;:SOUR1:FUNC:SQU:DCYC 78;:OUTP1 ON')
    ...
    PreTestResult4 = PIStateInfoWakeup == 1

    STLA_CAN.DBC.SetSignal(1, 'DYN_E_VCU_342', 'REVEIL_PRINCIPAL', 2)
    Sleep(5000)

    EndTime1 = TimeStamp()
    Test, PIStateInfoWakeup2 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','PI_STATE_INFO_WAKEUP', 0.0)
    TestResult11 = PIStateInfoWakeup2 == 0
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal('SUPV_V2_OBC_DCDC_591','ECU_ELEC_STATE_RCD',3,ConditionEnum.Equal,0,0,[],[])
    EndTime1 = dArrTimeStamp0[0]
    TestResult12 = len(dArrTimeStamp0) > 0
    TestResult1 = True if TestResult11 and TestResult12 else False


    CursorPosition = [StartTime, EndTime1]
