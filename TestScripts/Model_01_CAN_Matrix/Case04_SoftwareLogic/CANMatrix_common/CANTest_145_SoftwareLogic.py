...
if __name__ == '__main__':
    ...
    PreCondition = STLA_M_EncapsulationClass.RCDStateFlow_NormalMainWakeup()
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ECU_ELEC_STATE_RCD'),'ECU_ELEC_STATE_RCD',3,ConditionEnum.Equal,0,0)
    Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ECU_ELEC_STATE_RCD'),'ECU_ELEC_STATE_RCD',4,ConditionEnum.Equal,StartTime1,0)
