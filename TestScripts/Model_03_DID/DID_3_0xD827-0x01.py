...
if __name__ == '__main__':
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB',1,ConditionEnum.Equal,0,0,[],[])
    TestResult1 = len(dArrTimeStampList0) > 0
