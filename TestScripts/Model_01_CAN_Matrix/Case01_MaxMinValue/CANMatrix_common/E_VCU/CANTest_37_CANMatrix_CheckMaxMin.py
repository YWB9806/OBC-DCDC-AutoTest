...
if __name__ == '__main__':
    ...
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DAT_TBMU_373','HV_BATT_REAL_VOLT_HD',1000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DAT_TBMU_373','HV_BATT_REAL_VOLT_HD',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_TBMU_373','HV_BATT_REAL_VOLT_HD',1000,ConditionEnum.Equal,0,0,[],[])
    FindReqTime = dArrTimeStamp1[10]
    FindStateTime = dArrTimeStamp2[0]

    CursorPosition = [FindReqTime, FindStateTime]
    STLA_CAN.DBC.ExportWfmFile(['DAT_TBMU_373'],
