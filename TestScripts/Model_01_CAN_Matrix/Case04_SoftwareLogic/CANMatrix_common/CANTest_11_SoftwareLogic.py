...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('ETAT_PRINCIP_SEV', forbidden_values=[3], normal_value=0, fault_code=131)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ETAT_PRINCIP_SEV'),'ETAT_PRINCIP_SEV',3,ConditionEnum.Equal,0,0)
    StartTime1 = dArrTimeStamp1[0]
    Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',131,ConditionEnum.Equal,StartTime1,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. Reporting IFB_V_VerInfo6or13or20=131, and the replace value=NA.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
