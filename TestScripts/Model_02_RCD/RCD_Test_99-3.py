...
if __name__ == '__main__':
    ...
    Test, MeasureKL30Current = 低压辅源.SCPI.Query(':MEAS:CURR? CH1')
    MeasureKL30Current = list(MeasureKL30Current)
    PreTestResult4 = MeasureKL30Current[0] <= 0.05
    print(MeasureKL30Current[0], PreTestResult4)

    信号发生器.SCPI.Write(':SOUR1:APPL:SQU 1000,8.5,0,0;:SOUR1:FUNC:SQU:DCYC 78;:OUTP1 ON')
    Sleep(5000)

    EndTime1 = TimeStamp()
    Test, PIStateInfoWakeup = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','PI_STATE_INFO_WAKEUP', 0.0)
    Test, HVBattRechargeWakeup = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','HV_BATT_RECHARGE_WAKEUP', 0.0)
    TestResult11 = PIStateInfoWakeup == 1
    TestResult12 = HVBattRechargeWakeup == 1
