...
if __name__ == '__main__':
    ...
    Test1, StartTime1 = STLA_CAN.DBC.FindMsg(get_message_for_signal('SUPPLIER_CODE_ZA'),0,0,FindMsgTypeEnum.First,0)
    EndTime1 = StartTime1 + 1000
    Test2, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('SUPPLIER_CODE_ZA'),'SUPPLIER_CODE_ZA',0,ConditionEnum.Unequal,0,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. The signal of SUPPLIER_CODE_ZA reports the System value in the FOS file [{dArrTimeStampList1[0]}].\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
