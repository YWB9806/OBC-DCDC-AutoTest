...
if __name__ == '__main__':
    ...
    # Test, IFB_Com_Temp_WaterCalc1 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('IFB_Com_Temp_WaterCalc1'),'DCDIFB_Com_Temp_WaterCalc1C_STATE_BB', 0.0)
    # if IFB_Com_Temp_WaterCalc1 < 20:
    #     debug_break("手动操作水浴,等待水温下降至20℃以下!")
    
    高压源载一体机.Set.Volt(dVolt=200)
    Sleep(5000)
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB',4,ConditionEnum.Equal,0,0,[],[])
