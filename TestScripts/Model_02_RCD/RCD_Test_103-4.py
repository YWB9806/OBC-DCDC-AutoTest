...
if __name__ == '__main__':
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:SQU 1000,18,0,0;:SOUR1:FUNC:SQU:DCYC 50;:OUTP1 ON')
    Sleep(5000)
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('IFB_CC_CP','IFB_CCCP_CP_Fre',1000,ConditionEnum.Morethan,StartTime1,0,[],[])
