...
if __name__ == '__main__':
    ...
    InitDevice()
    Sleep(1000)
    STLA_CAN.DBC.ConfigureSetting('EVTECH_STLA-M_TS-VF-2', 'TS_DCS_08', RecordFileType.BLF, None)
    ...
    print(f" 测试步骤1结果: {TestResult1}, 测试步骤1结果: {TestResult2}")
