...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, CCEMeapPowerSupplyWupState = STLA_CAN.DBC.GetSignal(1,'SUPV_V2_OBC_DCDC_591','CCE_MEAP_POWER_SUPPLY_WUP_STATE', 0.0)
    TestResult = CCEMeapPowerSupplyWupState == 0 
    print(f"CCE_MEAP_POWER_SUPPLY_WUP_STATE: {CCEMeapPowerSupplyWupState}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('SUPV_V2_OBC_DCDC_591',0,0,FindMsgTypeEnum.First,0)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','SUPV_V2_OBC_DCDC_591'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CCE_MEAP_POWER_SUPPLY_WUP_STATE'],
                                ''
    )
    Sleep(2000)
