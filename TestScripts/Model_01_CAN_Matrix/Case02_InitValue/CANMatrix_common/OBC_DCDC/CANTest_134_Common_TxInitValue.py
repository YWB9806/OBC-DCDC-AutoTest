...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, Reserved_13 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_551','RESERVED_13', 0.0)
    TestResult = Reserved_13 == 0
    print(f"RESERVED_13: {Reserved_13}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','RESERVED_13'],
                                ''
    )
    Sleep(2000)
