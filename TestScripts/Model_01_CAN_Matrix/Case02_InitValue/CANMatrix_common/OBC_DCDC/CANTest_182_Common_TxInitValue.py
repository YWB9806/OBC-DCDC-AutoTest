...
if __name__ == '__main__':
    ...
    Test, Reserved_7 = STLA_CAN.DBC.GetSignal(1,'NEW_JDD_OBC_DCDC_5B1','RESERVED_7', 0.0)
    TestResult11 = Reserved_7 == 0
    print(f"RESERVED_7: {Reserved_7}, TestResult11: {TestResult11}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('NEW_JDD_OBC_DCDC_5B1','RESERVED_7',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    Reserved_7 = dArrTimeStampList2[0]
    TestResult11 = Reserved_7 == 0
    print(f"RESERVED_7: {Reserved_7}, TestResult11: {TestResult11}")
