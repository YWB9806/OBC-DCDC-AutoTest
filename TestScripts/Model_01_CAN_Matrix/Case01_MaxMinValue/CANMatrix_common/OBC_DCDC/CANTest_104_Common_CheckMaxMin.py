...
if __name__ == '__main__':
    ...
    Test, CptProcess4B531 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','CPT_PROCESS_4B_531', 0.0)
    TestResult = (CptProcess4B531 >= 0) and (CptProcess4B531 <= 15)
    print(f"CPT_PROCESS_4B_531: {CptProcess4B531}, TestResult: {TestResult}")
    Sleep(20000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_531','CPT_PROCESS_4B_531',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_531','CPT_PROCESS_4B_531',15,ConditionEnum.Equal,0,0,[],[])
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CPT_PROCESS_4B_531'],
                                ''
    )
    Sleep(2000)
