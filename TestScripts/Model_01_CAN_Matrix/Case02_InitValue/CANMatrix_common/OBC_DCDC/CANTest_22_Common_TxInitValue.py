...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, DCDCConvLVVoltHD = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_281','DCDC_CONV_LV_VOLT_HD', 0.0)
    TestResult = DCDCConvLVVoltHD == 5.4 # 0x0E --> 5.4
    print(f"DCDC_CONV_LV_VOLT_HD: {DCDCConvLVVoltHD}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DAT_OBC_DCDC_281',0,0,FindMsgTypeEnum.First,0)

    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_281','DCDC_CONV_LV_VOLT_HD',5.4,ConditionEnum.Equal,StartTime,StartTime,[],[])
    DCDCConvLVVoltHD = dArrTimeStampList2[0]
    TestResult = DCDCConvLVVoltHD == 5.4 # 0x0E --> 5.4
    print(f"DCDC_CONV_LV_VOLT_HD: {DCDCConvLVVoltHD}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DAT_OBC_DCDC_281'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','DCDC_CONV_LV_VOLT_HD'],
                                ''
    )
    Sleep(2000)
