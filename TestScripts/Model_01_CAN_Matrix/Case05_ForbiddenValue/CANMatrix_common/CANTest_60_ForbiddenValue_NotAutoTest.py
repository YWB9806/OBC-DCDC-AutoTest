...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('CURR_SETPOINT_DCDC_LV_REQ', forbidden_values=[-409.6, -400.1, 400.1, 409.3], normal_value=0, fault_code=144)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('CURR_SETPOINT_DCDC_LV_REQ'),'CURR_SETPOINT_DCDC_LV_REQ',-405,ConditionEnum.Lessthan,0,0)
    StartTime1 = dArrTimeStamp1[0]
    Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',144,ConditionEnum.Equal,StartTime1,0)
    EndTime1 = dArrTimeStamp2[0]
    Test3, dArrTimeStamp3, dArrTimeStampList3 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('CURR_SETPOINT_DCDC_LV_REQ'),'CURR_SETPOINT_DCDC_LV_REQ',405,ConditionEnum.Morethan,0,0)
    StartTime2 = dArrTimeStamp3[0]
    Test4, dArrTimeStamp4, dArrTimeStampList4 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',144,ConditionEnum.Equal,StartTime2,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. /.\n"+
        f"3. Triggering a Level 3 failure, reporting IFB_V_VerInfo6or13or20=144 .\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
