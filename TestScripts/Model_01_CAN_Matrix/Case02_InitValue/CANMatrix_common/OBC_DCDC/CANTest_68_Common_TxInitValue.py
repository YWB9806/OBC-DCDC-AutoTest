...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, OBCEvseDCMaxPower = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_441','OBC_EVSE_DC_MAX_POWER', 0.0)
    TestResult = OBCEvseDCMaxPower == 0 # 0x2710
    print(f"OBC_EVSE_DC_MAX_POWER: {OBCEvseDCMaxPower}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DAT_OBC_DCDC_441',0,0,FindMsgTypeEnum.First,0)

    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_441','OBC_EVSE_DC_MAX_POWER',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    OBCEvseDCMaxPower = dArrTimeStampList2[0]
    TestResult = OBCEvseDCMaxPower == 0 # 0x2710
    print(f"OBC_EVSE_DC_MAX_POWER: {OBCEvseDCMaxPower}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DAT_OBC_DCDC_441'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_EVSE_DC_MAX_POWER'],
                                ''
    )
    Sleep(2000)
