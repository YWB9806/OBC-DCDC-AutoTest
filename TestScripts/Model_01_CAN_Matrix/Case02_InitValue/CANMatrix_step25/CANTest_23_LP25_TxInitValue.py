...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, ServerIntDefDelStatusOBC = STLA_CAN.DBC.GetSignal(1,'DCDC_5A6','SERVER_INT_DEF_DEL_STATUS_OBC', 0.0)
    TestResult = ServerIntDefDelStatusOBC == 0 
    print(f"SERVER_INT_DEF_DEL_STATUS_OBC: {ServerIntDefDelStatusOBC}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DCDC_5A6',0,0,FindMsgTypeEnum.First,0)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DCDC_5A6'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','SERVER_INT_DEF_DEL_STATUS_OBC'],
                                ''
    )
    Sleep(2000)
