...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetMessage(1,'BSIInfo_382',['0'])
    STLA_CAN.DBC.SetSignal(1,'BSIInfo_382','VCU_SYNCHRO_GPC',0)
    STLA_CAN.DBC.Trigger(1, 'BSIInfo_382', True)
    Sleep(2000)
    StartTime = TimeStamp()     # 获取毫秒级时间戳
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'BSIInfo_382','VCU_SYNCHRO_GPC',1)
    Sleep(2000)
    ...
    CloseAllDevice()
    CloseAllCANMessage()
    STLA_CAN.DBC.Trigger(1, 'BSIInfo_382', False)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','BSIInfo_382'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','VCU_SYNCHRO_GPC'],
                                ''
    )
    Sleep(2000)
