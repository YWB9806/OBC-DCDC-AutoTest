...
if __name__ == '__main__':
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:SQU 1000,8.0,0,0;:SOUR1:FUNC:SQU:DCYC 100;:OUTP1 ON')
    低压辅源.SCPI.Write(':SOUR2:VOLT 5;:SOUR2:CURR 3;:OUTP CH2,ON')
    Sleep(3000)
    ...
    StartTime = TimeStamp()
    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('VITESSE_VEHICULE_ROUES'), 'VITESSE_VEHICULE_ROUES', 11)  
    Sleep(2000)
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ECU_ELEC_STATE_RCD'),'ECU_ELEC_STATE_RCD',4,ConditionEnum.Equal,StartTime,0,[],[])
