...
if __name__ == '__main__':
    ...
    Test, TypeMessage = STLA_CAN.DBC.GetSignal(1,'NEW_JDD_OBC_DCDC_5B1','TYPE_MESSAGE', 0.0)
    TestResult11 = TypeMessage == 0
    print(f"TYPE_MESSAGE: {TypeMessage}, TestResult11: {TestResult11}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('NEW_JDD_OBC_DCDC_5B1','TYPE_MESSAGE',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    TypeMessage = dArrTimeStampList2[0]
    TestResult11 = TypeMessage == 0
    print(f"TYPE_MESSAGE: {TypeMessage}, TestResult11: {TestResult11}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','TYPE_MESSAGE'],
                                ''
    )
    Sleep(2000)
