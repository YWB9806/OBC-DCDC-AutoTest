...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('BMS_DC_RELAY_MES_EVSE_VOLTAGE'),'BMS_DC_RELAY_MES_EVSE_VOLTAGE', 16)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"3. /. \n"+
        f"4. Result_Test_DCLinesOutOfRange= OK (no 159 fault trigger)\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
