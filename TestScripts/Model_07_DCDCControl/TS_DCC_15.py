...
if __name__ == '__main__':
    ...
    test_configs = [
        {
            "name": "LVDC电流测试",
            "setcurrents": [50, 100, 150, 200, 250],
            "expectcurrents": [50, 100, 150, 200, 250]
        },
    ]
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1. DCDC entes BUCK mode, and output current is reported in real time with =50A/100A/150A/200A/250A.\n"+
        f"\n"+
        f"Output current accuracy: \n"+
        f"(1) 5A≤Iout≤50A: ≤±10% \n"+
        f"(2) 50A<Iout: ≤±5A \n"+
        f"\n"+
        f"========================================================================="+
