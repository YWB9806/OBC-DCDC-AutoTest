...
def run_test_with_different_configs():
    ...
    for config_vhl in [0, 1, 2, 3]:
        ...
        STLA_M_EncapsulationClass.TestCaseConfig(RecordStart=True, case_name="STLA-M-BEPR",case_id=f"CONFIG_VHL{config_vhl}")
        ...
        STLA_M_EncapsulationClass.TestCaseConfig(RecordStart=False, case_name="STLA-M-BEPR",case_id=f"CONFIG_VHL{config_vhl}")
