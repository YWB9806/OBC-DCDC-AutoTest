...
if __name__ == '__main__':
    ...
    # InitAllCANMessage()
    STLA_CAN.DBC.SetMessage(1,'V2_BSI_552',['0'])
    STLA_CAN.DBC.SetSignal(1,'V2_BSI_552','CPT_TEMPOREL_2',6553.5) 
    STLA_CAN.DBC.SetSignal(1,'V2_BSI_552','CPT_TEMPOREL_1',6553.45) 
    ...
    STLA_CAN.DBC.SetSignal(1,'V2_BSI_552','CPT_TEMPOREL_1',0)
    Sleep(2000)
    ...
    CloseAllDevice()
    CloseAllCANMessage()
    STLA_CAN.DBC.Trigger(1, 'V2_BSI_552', False)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','V2_BSI_552','V2_BSI_552'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CPT_TEMPOREL_2','CPT_TEMPOREL_1'],
                                ''
    )
    Sleep(2000)
