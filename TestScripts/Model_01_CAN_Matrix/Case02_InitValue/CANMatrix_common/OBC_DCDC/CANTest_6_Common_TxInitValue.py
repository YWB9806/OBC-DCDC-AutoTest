...
if __name__ == '__main__':
    ...
    Test, Reserved_51 = STLA_CAN.DBC.GetSignal(1,'VERS_OBC_DCDC_0CE','RESERVED_51', 0.0)
    TestResult = Reserved_51 == 0
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('VERS_OBC_DCDC_0CE','RESERVED_51',0,ConditionEnum.Equal,0,0,[],[])
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','VERS_OBC_DCDC_0CE'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','RESERVED_51'],
                                ''
    )
    Sleep(2000)
