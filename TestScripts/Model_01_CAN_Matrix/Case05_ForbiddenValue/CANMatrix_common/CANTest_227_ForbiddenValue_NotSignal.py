...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('TEMP_AIR_EXT', forbidden_values=[251], normal_value=0, fault_code=198)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('TEMP_AIR_EXT'),'TEMP_AIR_EXT',250,ConditionEnum.Morethan,0,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. /.\n"+
        f"3. Threr is no fault, reporting IFB_V_VerInfo6or13or20=198, and the replacement value = NA.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
