...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1,'DAT_VSM_5DD','TISTAMPSECURECLKMINS',0)
    Sleep(2000)
    StartTime = TimeStamp()     # 获取毫秒级时间戳
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DAT_VSM_5DD','TISTAMPSECURECLKMINS',59)
    Sleep(2000)
    ...
    STLA_CAN.DBC.ExportWfmFile(['DAT_VSM_5DD'],
                                ['TISTAMPSECURECLKMINS'],
                                ''
    )
    Sleep(2000)
