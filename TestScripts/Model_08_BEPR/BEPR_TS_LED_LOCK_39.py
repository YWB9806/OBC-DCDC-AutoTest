...
if __name__ == '__main__':
    ...
    # STLA_M_EncapsulationClass.Send590DiagMessageAndLog("03 22 D8 43")
    ...
    PreCondition = EvsePlugLockState == 1
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 43",
        expected_response=["0x04", "0x62", "0xD8", "0x43", "0x00"],
        check_len=5
    )
    Sleep(500)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 44",
        expected_response=["0x04", "0x62", "0xD8", "0x44", "0x00"],
        check_len=5
    )
    Sleep(500)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 31",
        expected_response=["0x04", "0x62", "0xD8", "0x31", "0x01"],
        check_len=5
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 46",
        expected_response=["0x04", "0x62", "0xD8", "0x46", "0x01"],
        check_len=5
    )
    Sleep(200)
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="04 31 01 DF 68",
        expected_response=["0x05", "0x71", "0x01", "0xDF", "0x68", "0x01"],
        check_len=6
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 44",
        expected_response=["0x04", "0x62", "0xD8", "0x44", "0x01"],
        check_len=5
    )
    Sleep(20)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 46",
        expected_response=["0x04", "0x62", "0xD8", "0x46", "0x00"],
        check_len=5
    )
    Sleep(20)
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 43",
        expected_response=["0x04", "0x62", "0xD8", "0x43", "0x01"],
        check_len=5
    )
    Sleep(20)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
    ...
    Sleep(1500)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="04 31 03 DF 68",
        expected_response=["0x07", "0x71", "0x03", "0xDF", "0x68", "0x02"],
        check_len=6
    )
    Sleep(5000)
