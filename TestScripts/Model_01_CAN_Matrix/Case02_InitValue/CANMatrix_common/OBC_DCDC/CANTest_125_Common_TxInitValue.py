...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, Reserved_3 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_541','RESERVED_3', 0.0)
    TestResult = Reserved_3 == 0 
    print(f"RESERVED_3: {Reserved_3}, TestResult: {TestResult}")
