...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, Reserved_46 = STLA_CAN.DBC.GetSignal(1,'SUPV_V2_OBC_DCDC_591','RESERVED_46', 0.0)
    TestResult = Reserved_46 == 0
    print(f"RESERVED_46: {Reserved_46}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','RESERVED_46'],
                                ''
    )
    Sleep(2000)
