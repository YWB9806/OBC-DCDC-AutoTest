...
if __name__ == '__main__':
    ...
    TestResult14 = PItoHVConversionState1 == 1
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ACDC_CONVERSION_STATE'),'ACDC_CONVERSION_STATE',1,ConditionEnum.Equal,0,0,[],[])
