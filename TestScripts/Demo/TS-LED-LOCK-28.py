...
if __name__ == '__main__':
    ...
    InitDevice()
    Sleep(1000)
    STLA_CAN.DBC.ConfigureSetting('EVTECH_STLA-M_TS-VF-2', 'TS-LED-LOCK-28', RecordFileType.BLF, None)
    ...
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_402','RECHARGE_HMI_STATE_EVO',4)
    Sleep(2000)
