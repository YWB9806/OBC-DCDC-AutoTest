...
if __name__ == '__main__':
    ...
    for resistance in range(SetCCResistance, MaxResistance + 1, Step):
        ...
        TestResult2Sequence.append(OBCChgrConnConf == 1)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('OBC_CHRG_CONN_CONF'),'OBC_CHRG_CONN_CONF',1,ConditionEnum.Equal,StartTime,0)
    Test, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('OBC_CHRG_CONN_CONF'),'OBC_CHRG_CONN_CONF',1,ConditionEnum.Equal,StartTime,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1.Report CCS_PlugDetected(OBC_CHRG_CONN_CONF)=PARTIALLY_PLUGGED.==>{TestResult2}\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
