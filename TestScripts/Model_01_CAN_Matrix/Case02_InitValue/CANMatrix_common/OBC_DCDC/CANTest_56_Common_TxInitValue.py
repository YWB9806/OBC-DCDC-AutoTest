...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, OBCEvseDCMinVoltage = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_421','OBC_EVSE_DC_MIN_VOLTAGE', 0.0)
    TestResult = OBCEvseDCMinVoltage == 1022 # 0x3FE
    print(f"OBC_EVSE_DC_MIN_VOLTAGE: {OBCEvseDCMinVoltage}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_421','OBC_EVSE_DC_MIN_VOLTAGE',1022,ConditionEnum.Equal,StartTime,StartTime,[],[])
    OBCEvseDCMinVoltage = dArrTimeStampList2[0]
    TestResult = OBCEvseDCMinVoltage == 1022 # 0x3FE
    print(f"OBC_EVSE_DC_MIN_VOLTAGE: {OBCEvseDCMinVoltage}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_EVSE_DC_MIN_VOLTAGE'],
                                ''
    )
    Sleep(2000)
