...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_398','CHARGE_RATIO_HV_BATT_HMI',-127)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DAT_E_VCU_398','CHARGE_RATIO_HV_BATT_HMI',-127,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_E_VCU_398','CHARGE_RATIO_HV_BATT_HMI',127,ConditionEnum.Equal,0,0,[],[])
