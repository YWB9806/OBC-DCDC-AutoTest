...
if __name__ == '__main__':
    ...
    Test, EcuElecStateRCD1 = STLA_CAN.DBC.GetSignal(1,'SUPV_V2_OBC_DCDC_591','ECU_ELEC_STATE_RCD', 0.0)
    TestResult11 = HVBattRechargeWakeup11 == 1
    TestResult12 = EcuElecStateRCD1 == 0
    ...
    Test, EcuElecStateRCD2 = STLA_CAN.DBC.GetSignal(1,'SUPV_V2_OBC_DCDC_591','ECU_ELEC_STATE_RCD', 0.0)
    TestResult13 = HVBattRechargeWakeup12 == 0
    TestResult14 = EcuElecStateRCD2 == 3
    TestResult1 = True if TestResult11 and TestResult12 and TestResult13 and TestResult14 else False
    print(f"TestResult11: {TestResult11}, TestResult12: {TestResult12}, TestResult13: {TestResult13}, TestResult14: {TestResult14}")
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('VCU_BSI_Wakeup_27A','MODE_EPS_REQUEST',3,ConditionEnum.Equal,0,0,[],[])
    StartTime0 = dArrTimeStamp1[0]

    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('VCU_BSI_Wakeup_27A','MODE_EPS_REQUEST',4,ConditionEnum.Equal,StartTime0,0,[],[])
    StartTime1 = dArrTimeStamp1[0]
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_531','HV_BATT_RECHARGE_WAKEUP',0,ConditionEnum.Equal,StartTime0,0,[],[])
    ...
    CursorPosition = [Pre_Transitory, StartTime0, StartTime1, EndTime1]
