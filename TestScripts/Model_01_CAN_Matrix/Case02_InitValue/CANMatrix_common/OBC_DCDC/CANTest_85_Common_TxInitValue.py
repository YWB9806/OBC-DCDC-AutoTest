...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, DCDCRealLvCurrHD = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_501','DCDC_REAL_LV_CURR_HD', 0.0)
    TestResult = DCDCRealLvCurrHD == 0 
    print(f"DCDC_REAL_LV_CURR_HD: {DCDCRealLvCurrHD}, TestResult: {TestResult}")
