...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, OBCWaterTemp = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_541','OBC_WATER_TEMP', 0.0)
    TestResult = OBCWaterTemp == 0 # 0x28
    print(f"OBC_WATER_TEMP: {OBCWaterTemp}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_WATER_TEMP'],
                                ''
    )
    Sleep(2000)
