...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1, 'VCU_BSI_Wakeup_27A', 'MODE_EPS_REQUEST', 0)
    Sleep(75000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('VCU_BSI_Wakeup_27A','MODE_EPS_REQUEST',0,ConditionEnum.Equal,StartTime0,0,[],[])
