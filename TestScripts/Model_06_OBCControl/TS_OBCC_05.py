...
if __name__ == '__main__':
    ...
    test_configs = [
        {
            "name": "HVDC电压测试",
            "setvoltages": [275, 300, 350, 400, 450, 465],
            "expectvoltages": [275, 300, 350, 400, 450, 465]
        },
    ]
    ...
    signal_list = ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                   'IFB_CCCP_CC_Res','OBC_FAULT_STATE','DCDC_FAULT_STATE','DCDC_REAL_HV_VOLT_HD','OBC_EVSE_STATE','OBC_EVSE_REQUEST','OBC_CHRG_CONN_CONF',
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f" 1.The OBC  can run normally,and  OBC output voltage is 275V /300V /350V /400V/ 450V/ 465V. \n"+
        f"\n"+
        f"Note:Full-range output voltage control accuracy: ±1%;\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
