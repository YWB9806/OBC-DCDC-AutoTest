...
if __name__ == '__main__':
    ...
    TestResult = OBCFaultState == 0
    print(f"OBC_FAULT_STATE: {OBCFaultState}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_421','OBC_FAULT_STATE',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    OBCFaultState = dArrTimeStampList2[0]
    TestResult = OBCFaultState == 0
    print(f"OBC_FAULT_STATE: {OBCFaultState}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_FAULT_STATE'],
                                ''
    )
    Sleep(2000)
