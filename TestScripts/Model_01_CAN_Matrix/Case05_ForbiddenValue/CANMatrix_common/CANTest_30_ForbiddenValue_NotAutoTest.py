...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('VOLT_SETPOINT_DCDC_REQ', forbidden_values=[16.1, 16.4, 16.7], normal_value=16, fault_code=142)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('VOLT_SETPOINT_DCDC_REQ'),'VOLT_SETPOINT_DCDC_REQ',16.1,ConditionEnum.Equal,0,0)
    StartTime1 = dArrTimeStamp1[0]
    Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',162,ConditionEnum.Equal,StartTime1,0)
    EndTime1 = dArrTimeStamp2[0]
    Test3, dArrTimeStamp3, dArrTimeStampList3 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('VOLT_SETPOINT_DCDC_REQ'),'VOLT_SETPOINT_DCDC_REQ',16.4,ConditionEnum.Equal,0,0)
    StartTime2 = dArrTimeStamp3[0]
    Test4, dArrTimeStamp4, dArrTimeStampList4 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',162,ConditionEnum.Equal,StartTime2,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. /.\n"+
        f"3. Trigger a Level 3 failure, reporting the Replacement Value is =NA, reporting  IFB_V_VerInfo6or13or20=142.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
