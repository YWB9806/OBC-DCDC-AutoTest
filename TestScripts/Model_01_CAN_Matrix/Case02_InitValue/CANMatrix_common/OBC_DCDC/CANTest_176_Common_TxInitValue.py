...
if __name__ == '__main__':
    ...
    Test, NombreTrames = STLA_CAN.DBC.GetSignal(1,'NEW_JDD_OBC_DCDC_5B1','NOMBRE_TRAMES', 0.0)
    TestResult11 = NombreTrames == 2
    print(f"NOMBRE_TRAMES: {NombreTrames}, TestResult11: {TestResult11}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('NEW_JDD_OBC_DCDC_5B1','NOMBRE_TRAMES',2,ConditionEnum.Equal,StartTime,StartTime,[],[])
    NombreTrames = dArrTimeStampList2[0]
    TestResult11 = NombreTrames == 2
    print(f"NOMBRE_TRAMES: {NombreTrames}, TestResult11: {TestResult11}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','NOMBRE_TRAMES'],
                                ''
    )
    Sleep(2000)
