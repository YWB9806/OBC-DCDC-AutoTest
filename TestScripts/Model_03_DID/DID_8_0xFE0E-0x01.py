...
if __name__ == '__main__':
    ...
    高压源载一体机.Set.Volt(dVolt=61)
    高压源载一体机.Out.Enable(eEnable.ON)
    Sleep(2000)
    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('REG_MODE_DCDC_BB_REQ'), 'REG_MODE_DCDC_BB_REQ', 2)  
    Sleep(2000)
    Test, DCDC_STATE_BB1 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB', 0.0)
    TestResult11 = DCDC_STATE_BB1 == 3
    ...
    Sleep(1500)
    Test, DCDC_STATE_BB2 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB', 0.0)
    TestResult12 = DCDC_STATE_BB2 == 6
    ...
    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('DATA_DIAG_2'), 'DATA_DIAG_2', 65038)  
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB',6,ConditionEnum.Equal,0,0,[],[])
