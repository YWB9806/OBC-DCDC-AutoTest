...
if __name__ == '__main__':
    ...
    TestResult = OBCChrgConnConf == 0
    print(f"OBC_CHRG_CONN_CONF: {OBCChrgConnConf}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_421','OBC_CHRG_CONN_CONF',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    OBCChrgConnConf = dArrTimeStampList2[0]
    TestResult = OBCChrgConnConf == 0
    print(f"OBC_CHRG_CONN_CONF: {OBCChrgConnConf}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_CHRG_CONN_CONF'],
                                ''
    )
    Sleep(2000)
