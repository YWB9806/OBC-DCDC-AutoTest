...
if __name__ == '__main__':
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('OBC_CHRG_CONN_CONF'),'OBC_CHRG_CONN_CONF',0,ConditionEnum.Equal,0,0,[],[])
