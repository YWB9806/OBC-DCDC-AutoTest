...
if __name__ == '__main__':
    ...
    电阻控制板.Modbus.SetRegister(iID=1,Reg=3072,Data='0')
    Sleep(5500)
    Test, OBCMaxChrgScktTemp = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_421','OBC_MAX_CHRG_SCKT_TEMP', 0.0)
    TestResult = OBCMaxChrgScktTemp == 0
    print(f"OBC_MAX_CHRG_SCKT_TEMP: {OBCMaxChrgScktTemp}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_421','OBC_MAX_CHRG_SCKT_TEMP',-40,ConditionEnum.Equal,StartTime,StartTime,[],[])
    OBCMaxChrgScktTemp = dArrTimeStampList2[0]
    TestResult = OBCMaxChrgScktTemp == -40 # 0x00 --> -40
    print(f"OBC_MAX_CHRG_SCKT_TEMP: {OBCMaxChrgScktTemp}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_MAX_CHRG_SCKT_TEMP'],
                                ''
    )
    Sleep(2000)
