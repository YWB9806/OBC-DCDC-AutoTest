...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('RECHARGE_HMI_STATE_EVO'),'RECHARGE_HMI_STATE_EVO', 0)
    ...
    TestResult2 = OBCChrgConnConf == 0
    print(f"OBC_CHRG_CONN_CONF={OBCChrgConnConf}时, 测试结果={TestResult2}")
    TestResult4 = debug_break("Charge LED is solid white color.", timeout = 30)
