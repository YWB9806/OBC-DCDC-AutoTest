...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'DYN_E_VCU_342','VITESSE_VEHICULE_ROUES',0)
    StartTime = TimeStamp()     # 获取毫秒级时间戳
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DYN_E_VCU_342','VITESSE_VEHICULE_ROUES',655.34)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DYN_E_VCU_342','VITESSE_VEHICULE_ROUES',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DYN_E_VCU_342','VITESSE_VEHICULE_ROUES',655.34,ConditionEnum.Equal,0,0,[],[])
    FindReqTime = dArrTimeStamp1[100]
