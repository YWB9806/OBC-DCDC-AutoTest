...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, BidirV2hgModeAvail = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_501','BIDIR_V2HG_MODE_AVAIL', 0.0)
    TestResult = BidirV2hgModeAvail == 0 
    print(f"BIDIR_V2HG_MODE_AVAIL: {BidirV2hgModeAvail}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','BIDIR_V2HG_MODE_AVAIL'],
                                ''
    )
    Sleep(2000)
