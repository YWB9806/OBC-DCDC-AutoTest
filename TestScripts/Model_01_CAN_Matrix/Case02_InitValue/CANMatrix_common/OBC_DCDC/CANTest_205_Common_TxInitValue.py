...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, OBCDCACActivPower = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_549','OBC_DC_AC_ACTIV_POWER', 0.0)
    TestResult = OBCDCACActivPower == 0 # 0x1F40
    print(f"OBC_DC_AC_ACTIV_POWER: {OBCDCACActivPower}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DAT_OBC_DCDC_549',0,0,FindMsgTypeEnum.First,0)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DAT_OBC_DCDC_549'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','OBC_DC_AC_ACTIV_POWER'],
                                ''
    )
    Sleep(2000)
