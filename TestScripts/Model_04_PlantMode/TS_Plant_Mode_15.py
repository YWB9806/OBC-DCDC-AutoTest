...
if __name__ == '__main__':
    ...
    TestResult3 = debug_break("BEPR_LockLEDCommand= OFF(Turn OFF LED), and BEPR Charge LED color is white.", timeout = 30)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1. EVSE_PLUG_LOCK_STATE ={EVSEPlugLockState}(BEPR connector unlocked). \n"+
        f"2. BEPR_LockLEDCommand= OFF(Turn OFF LED).\n"+
        f"3. BEPR Charge LED color is white.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
