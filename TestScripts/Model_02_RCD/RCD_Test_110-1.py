...
if __name__ == '__main__':
    ...
    低压辅源.SCPI.Write(':SOUR3:VOLT 3.5;:SOUR3:CURR 3;:OUTP CH3,ON')
    电阻控制板.Modbus.SetRegister(iID=1,Reg=3072,Data='220')
    Sleep(5000)

    信号发生器.SCPI.Write(':SOUR1:APPL:DC 1,1,4.4;:OUTP1 ON')
    Sleep(2500)
    信号发生器.SCPI.Write(':SOUR1:APPL:DC 1,1,3.5;:OUTP1 ON')
    低压辅源.SCPI.Write(':SOUR3:VOLT 4.4;:SOUR3:CURR 3;:OUTP CH3,ON')
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                'DAT_OBC_DCDC_531','SUPV_V2_OBC_DCDC_591','DAT_E_VCU_402','VCU_BSI_Wakeup_27A','VCU_BSI_Wakeup_27A'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'HV_BATT_CHARGE_WUP_STATE','RECHARGE_HMI_STATE_EVO','MODE_EPS_REQUEST','STOP_DELAYED_HMI_WAKEUP'],
                                ''
    )
    Sleep(2000)
