...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, HoldDiscontactorWakeup = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','HOLD_DISCONTACTOR_WAKEUP', 0.0)
    TestResult = HoldDiscontactorWakeup == 0 
    print(f"HOLD_DISCONTACTOR_WAKEUP: {HoldDiscontactorWakeup}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DAT_OBC_DCDC_531',0,0,FindMsgTypeEnum.First,0)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DAT_OBC_DCDC_531'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','HOLD_DISCONTACTOR_WAKEUP'],
                                ''
    )
    Sleep(2000)
