...
if __name__ == '__main__':
    ...
    TestResult14 = PItoHVConversionState1 == 2

    STLA_CAN.DBC.SetSignal(1, get_message_for_signal('ACDC_CONVERSION_REQUEST'), 'ACDC_CONVERSION_REQUEST', 0)  
    Sleep(20)
    StartTime1 = TimeStamp()
    Test, PItoHVConversionState2 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('ACDC_CONVERSION_STATE'),'ACDC_CONVERSION_STATE', 0.0)
    TestResult15 = PItoHVConversionState2 == 6
    TestResult1 = True if TestResult11 and TestResult12 and TestResult13 and TestResult14 and TestResult15 else False
    print(f"OBCEvseState的值为{OBCEvseState}, 测试结果为{TestResult11}")
    print(f"EvsePlugLockState的值为{EvsePlugLockState}, 测试结果为{TestResult12}")
    print(f"OBCFaultState的值为{OBCFaultState}, 测试结果为{TestResult13}")
    print(f"PItoHVConversionState1的值为{PItoHVConversionState1}, 测试结果为{TestResult14}")
    print(f"PItoHVConversionState2的值为{PItoHVConversionState2}, 测试结果为{TestResult15}")
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ACDC_CONVERSION_STATE'),'ACDC_CONVERSION_STATE',6,ConditionEnum.Equal,0,0,[],[])
