...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_398','HV_CHRG_CURR_REG_MODE_SP',-2000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DAT_E_VCU_398','HV_CHRG_CURR_REG_MODE_SP',-2000,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_E_VCU_398','HV_CHRG_CURR_REG_MODE_SP',2000,ConditionEnum.Equal,0,0,[],[])
