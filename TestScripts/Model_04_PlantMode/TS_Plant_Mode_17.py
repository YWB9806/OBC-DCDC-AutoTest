...
if __name__ == '__main__':
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1. AC input voltage is {TestResult31}. \n"+
        f"2. DC input voltage is {TestResult32}. \n"+
        f"3. CCS_ProximityLine input voltage is {TestResult33}.\n"+
        f"4. Duty cycle on the CCS_ControlPilotLine input is {TestResult34}.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
