...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, ChargeCableLockFault = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_501','CHARGE_CABLE_LOCK_FAULT', 0.0)
    TestResult = ChargeCableLockFault == 0 
    print(f"CHARGE_CABLE_LOCK_FAULT: {ChargeCableLockFault}, TestResult: {TestResult}")
    ...
    Test, StartTime = STLA_CAN.DBC.FindMsg('DAT_OBC_DCDC_501',0,0,FindMsgTypeEnum.First,0)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CHARGE_CABLE_LOCK_FAULT'],
                                ''
    )
    Sleep(2000)
