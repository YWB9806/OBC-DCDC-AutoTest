...
if __name__ == '__main__':
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="04 31 01 DF 6C",
        expected_response=["0x05", "0x71", "0x01", "0xDF", "0x6C", "0x01"],
        check_len=6
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="04 31 03 DF 6C",
        expected_response=["0x05", "0x71", "0x03", "0xDF", "0x6C", "0x01"],
        check_len=6
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 50",
        expected_response=["0x04", "0x62", "0xD8", "0x50", "0x50"],
        check_len=5
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 51",
        expected_response=["0x04", "0x62", "0xD8", "0x51", "0x50"],
        check_len=5
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 DA 0A",
        expected_response=["0x04", "0x62", "0xDA", "0x0A"],
        check_len=4
    )
    Sleep(200)
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 50",
        expected_response=["0x04", "0x62", "0xD8", "0x50", "0x00"],
        check_len=5
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="03 22 D8 51",
        expected_response=["0x04", "0x62", "0xD8", "0x51", "0x00"],
        check_len=5
    )
    Sleep(200)
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
    ...
    STLA_M_EncapsulationClass.Send590DiagMessageAndLog(
        message="04 31 03 DF 6C",
        expected_response=["0x07", "0x71", "0x03", "0xDF", "0x6C", "0x02"],
        check_len=6
    )
    Sleep(5000)
