...
if __name__ == '__main__':
    ...
    InitDevice()
    Sleep(1000)
    Log4NetWrapper.InitLogManage("EVTECH_STLA-M_TS-VF-2", "TS-SYS-01")
    ...
    for i in range(100):
        ...
        SingleResult = OBCChargeConnConf == 2
        Log4NetWrapper.WriteToOutput(f'IFB_CCCP_CC_Res:{CCRes},OBC_CHRG_CONN_CONF:{OBCChargeConnConf}')
    ...
    if TestResult == True:
        ...
        Log4NetWrapper.WriteToOutput(f'测试结果:{TestResultDisplay}')
        print(TestResultDisplay)
    Log4NetWrapper.WriteToOutput(f'$Report:Test result:{TestResultDisplay}#,$Actual test result:IFB_CCCP_CC_Res:{CCRes},OBC_CHRG_CONN_CONF{OBCChargeConnConf}#')
