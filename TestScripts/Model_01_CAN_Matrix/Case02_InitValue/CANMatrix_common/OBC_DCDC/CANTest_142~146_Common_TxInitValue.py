...
if __name__ == '__main__':
    ...
    TestResult = ECUElecStateRCD == 2
    print(f"ECU_ELEC_STATE_RCD: {ECUElecStateRCD}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('SUPV_V2_OBC_DCDC_591','ECU_ELEC_STATE_RCD',2,ConditionEnum.Equal,StartTime,StartTime,[],[])
    ECUElecStateRCD = dArrTimeStampList2[0]
    TestResult = ECUElecStateRCD == 2
    print(f"ECU_ELEC_STATE_RCD: {ECUElecStateRCD}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','ECU_ELEC_STATE_RCD'],
                                ''
    )
    Sleep(2000)
