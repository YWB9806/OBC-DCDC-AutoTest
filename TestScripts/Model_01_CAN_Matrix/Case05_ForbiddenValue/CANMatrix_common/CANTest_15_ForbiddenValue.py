...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('ETAT_RESEAU_ELEC', forbidden_values=[8, 15], normal_value=0, fault_code=162)
    ...
    Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ETAT_RESEAU_ELEC'),'ETAT_RESEAU_ELEC',8,ConditionEnum.Equal,0,0)
    ...
    Test3, dArrTimeStamp3, dArrTimeStampList3 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ETAT_RESEAU_ELEC'),'ETAT_RESEAU_ELEC',15,ConditionEnum.Equal,0,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2. Reporting IFB_V_VerInfo6or13or20=162, and the replace value=NA.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
