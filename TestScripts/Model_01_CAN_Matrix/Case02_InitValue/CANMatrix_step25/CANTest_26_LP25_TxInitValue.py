...
if __name__ == '__main__':
    InitDevice()
    Sleep(1000)
    Log4NetWrapper.InitLogManage("STLA-M-CANMatrix_STEP2.5", get_current_filename())
    STLA_CAN.DBC.ConfigureSetting('STLA-M-CANMatrix_STEP2.5', get_current_filename(), RecordFileType.BLF, None)
    ...
    STLA_CAN.DBC.SetSignal(1, 'DAT_E_VCU_422', 'CONFIG_VHL', 6)
    Sleep(5500)
    ...
    Sleep(5500)
    # Test, ArrData2 = STLA_CAN.DBC.GetMessage(1, 'NEW_JDD_OBC_DCDC_5B1')
    # ArrData2 = list(ArrData2)
    # TestResult11 = ArrData2[0] != 0
    Test, ReferenceHoraire = STLA_CAN.DBC.GetSignal(1,'NEW_JDD_OBC_DCDC_5B1','REFERENCE_HORAIRE', 0.0)
    TestResult11 = ReferenceHoraire == 429496729.4
    print(f"REFERENCE_HORAIRE: {ReferenceHoraire}, TestResult11: {TestResult11}")
    ...
    # Test, StartTime = STLA_CAN.DBC.FindMsg('NEW_JDD_OBC_DCDC_5B1',0,0,FindMsgTypeEnum.First,0)

    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('NEW_JDD_OBC_DCDC_5B1','REFERENCE_HORAIRE',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    ReferenceHoraire = dArrTimeStampList2[0]
    TestResult11 = ReferenceHoraire == 429496729.4
    print(f"REFERENCE_HORAIRE: {ReferenceHoraire}, TestResult11: {TestResult11}")
    ...
    TestResult = True if TestResult11  else False
    if TestResult == True:
