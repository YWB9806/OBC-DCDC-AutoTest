...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1, 'DAT_E_VCU_402', 'RECHARGE_HMI_STATE_EVO', 6)
    ...
    TestResult1 = min(TestResultList)
    Sleep(5000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('IFB_CVN','IFB_CVN_CheckSum1',1,ConditionEnum.Equal,0,0,[],[])
    StartTime1 = dArrTimeStamp1[0]
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('IFB_CVN','IFB_CVN_CheckSum1',15,ConditionEnum.Equal,StartTime1,0,[],[])
