...
if __name__ == '__main__':
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DYN_E_VCU_342','CPT_PROCESS_4B_342',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DYN_E_VCU_342','CPT_PROCESS_4B_342',15,ConditionEnum.Equal,0,0,[],[])
