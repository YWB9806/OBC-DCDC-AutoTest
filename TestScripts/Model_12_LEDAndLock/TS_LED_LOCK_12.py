...
if __name__ == '__main__':
    ...
    STLA_M_EncapsulationClass.TestCaseConfig(RecordStart = True, case_name = "STLA-M-STEP2.5_LEDAndLock")
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:SQU 1000,18,0,0;:SOUR1:FUNC:SQU:DCYC 80;:OUTP1 ON')
    Sleep(5000)
    信号发生器.SCPI.Write(':SOUR1:APPL:DC 1,1,2.0;:OUTP1 OFF')
    Sleep(30000)
    ...
    # STLA_CAN.DBC.SetSignal(1, get_message_for_signal('RECHARGE_HMI_STATE_EVO'),'RECHARGE_HMI_STATE_EVO', 3)
    # Sleep(5000)
    ...
    STLA_M_EncapsulationClass.TestCaseConfig(RecordStart = False, case_name = "STLA-M-STEP2.5_LEDAndLock")
