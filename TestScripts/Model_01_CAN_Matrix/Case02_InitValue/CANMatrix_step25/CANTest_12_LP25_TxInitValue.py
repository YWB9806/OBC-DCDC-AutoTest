...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, Reserved_6 = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_531','RESERVED_6', 0.0)
    TestResult = Reserved_6 == 0 
    print(f"RESERVED_6: {Reserved_6}, TestResult: {TestResult}")
