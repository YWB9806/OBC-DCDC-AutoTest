...
if __name__ == '__main__':
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:DC 1,1,4.5;:OUTP1 OFF')
    Sleep(1500)
    ...
    EndTime1 = TimeStamp()
    Test, IFB_CVN_CheckSum0 = STLA_CAN.DBC.GetSignal(1,'IFB_CVN','IFB_CVN_CheckSum0', 0.0)
    Test, BidirV2lAvail = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_501','BIDIR_V2L_AVAIL', 0.0)
    TestResult11 = IFB_CVN_CheckSum0 == 0
    TestResult12 = BidirV2lAvail == 1
    ...
    # Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('TBMU_V2_4F4','HV_BATT_CH_NEED_STATE',1,ConditionEnum.Equal,0,0,[],[])
    # StartTime1 = dArrTimeStamp1[0]
    # Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('IFB_CVN','IFB_CVN_CheckSum0',0,ConditionEnum.Equal,StartTime1,0,[],[])
    # EndTime1 = dArrTimeStamp2[0]
    # TestResult2 = abs(abs(EndTime1 - StartTime1) - 5000) < 500
    # print(f"步骤2: IFB_CVN_CheckSum0的状态从1变为0的时间间隔为{abs(EndTime1 - StartTime1)}秒")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                'DAT_OBC_DCDC_281','DAT_OBC_DCDC_501'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'HV_BATT_CH_NEED_STATE','CCS_V2L_PLUG_DETECTED','BIDIR_V2L_AVAIL'],
                                ''
    )
    Sleep(2000)
