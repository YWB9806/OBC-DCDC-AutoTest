...
if __name__ == '__main__':
    ...
    # InitAllCANMessage()
    STLA_CAN.DBC.SetMessage(1,'DYN_E_VCU_428',['0'])
    STLA_CAN.DBC.SetSignal(1,'DYN_E_VCU_428','CURR_SETPOINT_DCDC_LV_REQ',0)
    STLA_CAN.DBC.Trigger(1, 'DYN_E_VCU_428', True)
    Sleep(8000)
    ...
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DYN_E_VCU_428','CURR_SETPOINT_DCDC_LV_REQ',250)
    Sleep(2000)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DYN_E_VCU_428'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CURR_SETPOINT_DCDC_LV_REQ'],
                                ''
    )
    Sleep(2000)
