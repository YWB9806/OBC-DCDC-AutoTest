...
if __name__ == '__main__':
    ...
    Sleep(5500)
    Test, DCDCRealHVVoltHD = STLA_CAN.DBC.GetSignal(1,'DAT_OBC_DCDC_541','DCDC_REAL_HV_VOLT_HD', 0.0)
    TestResult = DCDCRealHVVoltHD == 0 
    print(f"DCDC_REAL_HV_VOLT_HD: {DCDCRealHVVoltHD}, TestResult: {TestResult}")
    ...
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_OBC_DCDC_541','DCDC_REAL_HV_VOLT_HD',0,ConditionEnum.Equal,StartTime,StartTime,[],[])
    DCDCRealHVVoltHD = dArrTimeStampList2[0]
    TestResult = DCDCRealHVVoltHD == 0
    print(f"DCDC_REAL_HV_VOLT_HD: {DCDCRealHVVoltHD}, TestResult: {TestResult}")
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','DCDC_REAL_HV_VOLT_HD'],
                                ''
    )
    Sleep(2000)
