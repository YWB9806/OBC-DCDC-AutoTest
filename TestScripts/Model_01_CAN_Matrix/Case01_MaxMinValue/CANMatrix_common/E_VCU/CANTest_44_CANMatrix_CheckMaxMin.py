...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'DAT_TBMU_3B4','MAX_ALLOW_CHRG_VOLTAGE',0)
    StartTime = TimeStamp()     # 获取毫秒级时间戳
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DAT_TBMU_3B4','MAX_ALLOW_CHRG_VOLTAGE',1000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DAT_TBMU_3B4','MAX_ALLOW_CHRG_VOLTAGE',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_TBMU_3B4','MAX_ALLOW_CHRG_VOLTAGE',1000,ConditionEnum.Equal,0,0,[],[])
    FindReqTime = dArrTimeStamp1[10]
    FindStateTime = dArrTimeStamp2[10]

    CursorPosition = [FindReqTime, FindStateTime]
    STLA_CAN.DBC.ExportWfmFile(['DAT_TBMU_3B4'],
                                ['MAX_ALLOW_CHRG_VOLTAGE'],
                                ''
    )
    Sleep(2000)
