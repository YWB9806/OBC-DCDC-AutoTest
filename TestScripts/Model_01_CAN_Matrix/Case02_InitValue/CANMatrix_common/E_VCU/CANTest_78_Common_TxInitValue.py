...
if __name__ == '__main__':
    ...
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_4F1','MAX_INDI_CHRG_CURR',0) # 0x7D0
    ...
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_4F1','MAX_INDI_CHRG_CURR',0)
    Sleep(2000)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','MAX_INDI_CHRG_CURR'],
                                ''
    )
    Sleep(2000)
