...
if __name__ == '__main__':
    ...
    信号发生器.SCPI.Write(':SOUR1:APPL:DC 1,1,4.6;:OUTP1 ON')
    Sleep(2500)
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ECU_ELEC_STATE_RCD'),'ECU_ELEC_STATE_RCD',0,ConditionEnum.Equal,0,0,[],[])
