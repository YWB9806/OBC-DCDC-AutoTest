...
if __name__ == '__main__':
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('DCDC_REAL_HV_VOLT_HD'),'DCDC_REAL_HV_VOLT_HD',60,ConditionEnum.Morethan,0,0)
    Test, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('DCDC_STATE_BB'),'DCDC_STATE_BB',6,ConditionEnum.Equal,0,0)
    ...
    signal_list = ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                   ...
                   'DCDC_STATE_BB','HV_ACTIVE_DISCH_REQ']
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1-4:DCDC_STATE_BB={DCDCStateBB1}.\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
    )
