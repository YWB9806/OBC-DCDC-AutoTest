...
if __name__ == '__main__':
    ...
    Test, EditionSoft = STLA_CAN.DBC.GetSignal(1,'VERS_OBC_DCDC_0CE','EDITION_SOFT', 0.0)
    TestResult = (EditionSoft >= 0) and (EditionSoft <= 255)
    print(f"EDITION_SOFT: {EditionSoft}, TestResult: {TestResult}")
    Sleep(15000)
    Sleep(5000)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','EDITION_SOFT'],
                                ''
    )
    Sleep(2000)
