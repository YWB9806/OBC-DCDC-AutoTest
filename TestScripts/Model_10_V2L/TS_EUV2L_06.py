...
if __name__ == '__main__':
    ...
    电阻控制板.Modbus.SetRegister(iID=1,Reg=3072,Data='965')
    Sleep(1500)
    ...
    电阻控制板.Modbus.SetRegister(iID=1,Reg=3072,Data='537')
    Sleep(1500)
    Test, BidirV2LAvail2 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('BIDIR_V2L_AVAIL'),'BIDIR_V2L_AVAIL', 0.0)
    TestResult2 = BidirV2LAvail2 == 1
    print(f"BIDIR_V2L_AVAIL:{BidirV2LAvail2},测试结果2:{TestResult2}")

    Sleep(15000)
    Test, BidirV2LAvail3 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('BIDIR_V2L_AVAIL'),'BIDIR_V2L_AVAIL', 0.0)
    Test, CPVolt2 = STLA_CAN.DBC.GetSignal(1,get_message_for_signal('IFB_CCCP_CP_Volt'),'IFB_CCCP_CP_Volt', 0.0)
    TestResult31 = BidirV2LAvail3 == 0
    TestResult32 = CPVolt2 == 0
    TestResult3 = True if TestResult31 and TestResult32 else False
    print(f"BIDIR_V2L_AVAIL:{BidirV2LAvail3},测试结果3-1:{TestResult31}")
    print(f"IFB_CCCP_CP_Volt:{CPVolt2},测试结果3-2:{TestResult32}")
    ...
    Test, dArrTimeStamp4, dArrTimeStampList4 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('BIDIR_V2L_AVAIL'),'BIDIR_V2L_AVAIL',0,ConditionEnum.Equal,Time3,0)
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        ...
        f"2.BIDIR_V2L_AVAIL={BidirV2LAvail2}.\n"+
        f"3.CP voltage ={CPVolt2}V,BIDIR_V2L_AVAIL={BidirV2LAvail3}.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
