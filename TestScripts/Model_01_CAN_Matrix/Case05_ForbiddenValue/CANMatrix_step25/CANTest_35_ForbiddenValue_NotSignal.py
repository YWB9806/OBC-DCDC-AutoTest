...
if __name__ == '__main__':
    ...
    _ , TestResult2 = STLA_M_EncapsulationClass.CANMatrixForbiddenValueTest('TISTAMPSECURECLKSEC1', forbidden_values=[60, 61], normal_value=0, fault_code=999)
    ...
    # Test1, dArrTimeStamp1, dArrTimeStampList1 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ETAT_DISCONT_BATT_HT'),'ETAT_DISCONT_BATT_HT',250,ConditionEnum.Morethan,0,0)
    # StartTime1 = dArrTimeStamp1[0]
    # Test2, dArrTimeStamp2, dArrTimeStampList2 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',198,ConditionEnum.Equal,StartTime1,0)
    # EndTime1 = dArrTimeStamp2[0]
    # Test3, dArrTimeStamp3, dArrTimeStampList3 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('TEMP_AIR_EXT'),'TEMP_AIR_EXT',250,ConditionEnum.Unequal,0,0)
    # StartTime2 = dArrTimeStamp3[0]
    # Test4, dArrTimeStamp4, dArrTimeStampList4 = STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('IFB_V_VerInfo6or13or20'),'IFB_V_VerInfo6or13or20',198,ConditionEnum.Unequal,StartTime2,0)
    ...
    #                'ECU_ELEC_STATE_RCD','DCDC_STATE_BB','ACDC_CONVERSION_REQUEST','ACDC_CONVERSION_STATE','TEMP_AIR_EXT'
    #                ]
