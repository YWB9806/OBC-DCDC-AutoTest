...
if __name__ == '__main__':
    ...
    # InitAllCANMessage()
    STLA_CAN.DBC.SetMessage(1,'DAT_E_VCU_458',['0'])
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_458','MAX_INDI_DISCHRG_POWER',0)
    STLA_CAN.DBC.Trigger(1, 'DAT_E_VCU_458', True)
    Sleep(8000)
    ...
    Sleep(15000)
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_458','MAX_INDI_DISCHRG_POWER',7000)
    Sleep(2000)
    ...
    CloseAllDevice()
    CloseAllCANMessage()
    STLA_CAN.DBC.Trigger(1, 'DAT_E_VCU_458', False)
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                'IFB_CC_CP','IFB_CC_CP','DYN_E_VCU_342','SUPV_V2_OBC_DCDC_591','DAT_E_VCU_458'],
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','MAX_INDI_DISCHRG_POWER'],
                                ''
    )
    Sleep(2000)
