...
if __name__ == '__main__':
    ...
    InitAllCANMessage()
    STLA_CAN.DBC.SetSignal(1,'DAT_E_VCU_402','CHARGE_REMAINING_TIME_HMI',0)
    ...
    # Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DAT_E_VCU_402','KM_TOTAL',1677721.4,ConditionEnum.Equal,0,0,[],[])
    # FindReqTime = dArrTimeStamp1[10]
    # FindStateTime = dArrTimeStamp2[0]

    CursorPosition = [StartTime, EndTime]
    STLA_CAN.DBC.ExportWfmFile(['DAT_E_VCU_402'],
                                ['CHARGE_REMAINING_TIME_HMI'],
                                ''
    )
    Sleep(2000)
