...
if __name__ == '__main__':
    ...
    test_configs = [
        {
            "name": "HVDC电流测试",
            "voltages": [190, 275, 300, 350, 400, 450, 465],
            "currents": [-28, -39, -35, -30, -27, -24, -23]
        },
    ]
    ...
    signal_list = ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                   'IFB_CCCP_CC_Res','OBC_FAULT_STATE','DCDC_FAULT_STATE','OBC_DC_MAX_CURRENT','OBC_EVSE_STATE','OBC_EVSE_REQUEST','OBC_CHRG_CONN_CONF',
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1.In charging mode,when  DC Voltage is 190V/275V/300V/350V/400V/450V/465V,  wait 5s, \n"+
        f"check the PItoHVConversion_MaxChHVCurrent(OBC_DC_MAX_CURRENT)  reporting value is 28A/39A/35A/30A/27A/24A/23A \n"+
        f"\n"+
