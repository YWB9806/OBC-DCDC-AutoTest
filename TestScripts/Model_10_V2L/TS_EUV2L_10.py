...
if __name__ == '__main__':
    ...
    STLA_M_EncapsulationClass.V2LStart()
    ...
    PreCondition1 = True if PreTestResult1 and PreTestResult2 and PreTestResult3 and PreTestResult4 and PreTestResult5 else False
    ...
    print(f"BIDIR_V2L_AVAIL:{BidirV2LAvail1},测试结果1-2:{TestResult12}")
    ...
    PreTestResult4 = BidirV2LAvail == 1
    PreTestResult5 = CPVolt >= 5.0
    PreCondition2 = True if PreTestResult1 and PreTestResult2 and PreTestResult3 and PreTestResult4 and PreTestResult5 else False
    print(f"OBC_FAULT_STATE:{OBCFaultState},前置条件1结果:{PreTestResult1}")
    print(f"AC_CHARGE_MODE_AVAIL:{ACChargeModeAvail},前置条件2结果:{PreTestResult2}")
    print(f"CCS_V2L_PLUG_DETECTED:{CCSV2LPlugDetected},前置条件3结果:{PreTestResult3}")
    print(f"BIDIR_V2L_AVAIL:{BidirV2LAvail},前置条件4结果:{PreTestResult4}")
    ...
    电阻控制板.Modbus.SetRegister(iID=1,Reg=3072,Data='3300')
    Sleep(1500)
    ...
    TestResult21 = CPVolt1 == 0
    TestResult22 = BidirV2LAvail2 == 0
    TestResult2 = True if TestResult21 and TestResult22 else False
    print(f"IFB_CCCP_CP_Volt:{CPVolt2},测试结果2-1:{TestResult21}")
    print(f"BIDIR_V2L_AVAIL:{BidirV2LAvail2},测试结果2-2:{TestResult22}")
    ...
    print(f"前置条件1结果: {PreCondition1}, 前置条件2结果: {PreCondition2},测试步骤1结果: {TestResult1}, 测试步骤2结果: {TestResult2}")
    TestResult = True if PreCondition1 and PreCondition2 and TestResult1 and TestResult2 else False
    if TestResult == True:
    ...
    Log4NetWrapper.WriteToOutput_KeyInfo(TestResultDisplay, 
        f"\n"+
        f"1.BIDIR_V2L_AVAIL={BidirV2LAvail1} / {BidirV2LAvail2}.\n"+
        f"\n"+
        f"========================================================================="+
        f"\n"+
        f"{all_prints}"
