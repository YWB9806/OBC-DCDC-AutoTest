...
if __name__ == '__main__':
    ...
    TestResult1 = PItoHVConversionState == 0
    ...
    Test, dArrTimeStamp0, dArrTimeStampList0= STLA_CAN.DBC.FindValueOfSignal(get_message_for_signal('ACDC_CONVERSION_STATE'),'ACDC_CONVERSION_STATE',0,ConditionEnum.Equal,0,0,[],[])
