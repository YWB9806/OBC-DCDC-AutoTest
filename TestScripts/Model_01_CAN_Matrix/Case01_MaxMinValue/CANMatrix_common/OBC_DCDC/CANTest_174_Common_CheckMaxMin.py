...
if __name__ == '__main__':
    ...
    Test, CptProcess4B5A6 = STLA_CAN.DBC.GetSignal(1,'DCDC_5A6','CPT_PROCESS_4B_5A6', 0.0)
    TestResult = (CptProcess4B5A6 >= 0) and (CptProcess4B5A6 <= 15)
    print(f"CPT_PROCESS_4B_5A6: {CptProcess4B5A6}, TestResult: {TestResult}")
    Sleep(20000)
    ...
    Test, dArrTimeStamp1, dArrTimeStampList1= STLA_CAN.DBC.FindValueOfSignal('DCDC_5A6','CPT_PROCESS_4B_5A6',0,ConditionEnum.Equal,0,0,[],[])
    Test, dArrTimeStamp2, dArrTimeStampList2= STLA_CAN.DBC.FindValueOfSignal('DCDC_5A6','CPT_PROCESS_4B_5A6',15,ConditionEnum.Equal,0,0,[],[])
    ...
    STLA_CAN.DBC.ExportWfmFile(['IFB_VersionInfo','IFB_Volt','IFB_Volt','IFB_Volt','SUPV_V2_OBC_DCDC_591','IFB_CC_CP','IFB_CC_CP',
                                ...
                                ['IFB_V_VerInfo6or13or20','IFB_Volt_KL30','IFB_Volt_KL15','IFB_Volt_LVCC','RCD_LINE_STATE',
                                 ...
                                 'ECU_ELEC_STATE_RCD','CPT_PROCESS_4B_5A6'],
                                ''
    )
    Sleep(2000)
